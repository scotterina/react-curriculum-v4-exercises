...
// Explanation:
// state shouldn't be manually changed as it can cause updates to be missed
// the setCount function be be used to ensure that updates are tracked and renders correctly
